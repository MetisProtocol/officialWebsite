  ...
  return <nav className="metis_fe--layout-header">
    ...
    <a className="whitepaper-link" href="/files/metis_whitepaper.pdf" target="__blank">
      ...
      <svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1 5L11 5" stroke="#01BCB1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M7.40002 1L11 5.05L7.40002 9.1" stroke="#01BCB1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    </a>
  </nav>;
}
